...
export const globalShortcuts = {
  bind: (payload: ShortcutBindRequest) =>
    cmd<ShortcutSession>("bind_global_shortcut", { payload }),
  unbind: (sessionId: string) =>
    cmd<void>("unbind_global_shortcut", { sessionId }),
};
...
export const remoteDesktop = {
  createSession: () =>
    cmd<RemoteDesktopSession>("create_remote_desktop_session"),
  injectText: (sessionId: string, text: string) =>
    cmd<void>("inject_text", { sessionId, text }),
  closeSession: (sessionId: string) =>
    cmd<void>("close_remote_desktop_session", { sessionId }),
};
